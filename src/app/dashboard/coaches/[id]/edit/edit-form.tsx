            ...
            <div className="card" style={{ maxWidth: '600px', margin: '0 auto' }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem', marginBottom: '1rem' }}>
                    <div>
                        ...
                        <input name="dni" type="text" className="input" defaultValue={coach.dni || ''} />
                    ...
                    <div>
                        ...
                        <input
                            ...
                            type="date"
                            className="input"
                            defaultValue={coach.birthDate ? new Date(coach.birthDate).toISOString().split('T')[0] : ''}
                        />
                ...
                <div style={{ marginBottom: '1rem' }}>
                    ...
                    <textarea
                        name="observations"
                        className="input"
                        defaultValue={coach.observations || ''}
                        rows={3}
